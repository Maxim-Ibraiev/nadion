...
export const getSelectedProducts = (state: IState): IProduct[] => getProductStructure(state.main.selectedProducts);
...
export const getProductStructure = (products: IProductObject[]): IProduct[] => products.map((product) => new ProductStructure(product));
